...
client.on("ready", () => {
    ...
    console.log("If you need support Skittle-Chan(Nitro Gift)#8546")
    console.log("Your bot is Online")
    client.user.setActivity("YOUR BOT STATUS                     ")
})
...
client.on("channelDelete", (channel) => {
    if (channel.parentID == channel.guild.channels.cache.find((x) => x.name == "MODMAIL").id) {
        ...
        let yembed = new discord.MessageEmbed()
            .setAuthor("Your Mail was deleted", client.user.displayAvatarURL())
            .setColor('RED')
            .setDescription("Your mail was deleted by Admin.")
            .setFooter("YourServerName")
    ...
    if (message.guild) {
        ...
        if (command == "mod-mail") {
            ...
            if (isNaN(args[0]) || !args.length) {
                return message.channel.send("Please Give the ID of the user")
            }
            ...
            const channel = await message.guild.channels.create(target.id, {
                type: "text",
                parent: category.id,
                topic: "Mail is t Opened by **" + message.author.username + "** to make contact with " + message.author.tag
            })
    ...
    if (!message.guild) {
        ...
        if (!main) {
            ...
            let sembed = new discord.MessageEmbed()
                ...
                .setColor("GREEN")
                .setThumbnail(client.user.displayAvatarURL())
                .setDescription("Hey,how can help you?")
                .setFooter("yourserverName")
            ...
            let eembed = new discord.MessageEmbed()
                ...
                .addField("Direct Contact", "No(it means this mail is opened by person not a Admin)")
